...
(function () {
  ...
  const TOPBAR_SUPABASE_URL = 'https://srbllmkcmufpwmsbxqbf.supabase.co';
  const TOPBAR_SUPABASE_KEY = 'sb_publishable_7HbXI_uqPjGz2NPhiTtQVw_vPC9YOTH';
...
<nav class="bottombar" id="bottombar" role="navigation" aria-label="Main tabs">
  ...
  function currentPageKey() {
    ...
    if (p.endsWith('learn.html') || p.endsWith('japanese.html') || p.endsWith('reading.html')) return 'learn';
